...
//   return (
//     <div className={`flex flex-col bg-white rounded-xl overflow-hidden shadow-sm transition-all duration-200 hover:shadow-md border ${
//       isApproved ? "border-emerald-200 hover:border-emerald-300 shadow-emerald-50"
//       : isRejected ? "border-red-200 hover:border-red-300 shadow-red-50"
